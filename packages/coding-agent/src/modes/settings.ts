...
export const cfgComposerStyleFooterMode = register({
	id: "composerStyle.footerMode",
	type: "enum",
...
effect(cfgComposerStyleFooterMode, mode => setComposerStylePreferences({ footerMode: mode }));
...
export const cfgDisplayCollapseCommandCards = register({
	id: "display.collapseCommandCards",
	type: "boolean",
	default: true,
	ui: {
		tab: "appearance",
...
effect(
	combine({
		...
		collapseCommandCards: cfgDisplayCollapseCommandCards,
	}),
...
export const cfgTerminalReportCwd = register({
	id: "terminal.reportCwd",
	type: "boolean",
	default: false,
	ui: {
		tab: "appearance",
...
export const cfgTuiWorkingTimer = register({
	id: "tui.workingTimer",
	type: "boolean",
	default: true,
	ui: {
...
export const cfgTuiWorkingTimerMinSeconds = register({
	id: "tui.workingTimerMinSeconds",
	type: "number",
	default: 0,
	ui: {
		tab: "appearance",
...
export const cfgTuiPinComposerBottom = register({
	id: "tui.pinComposerBottom",
	type: "boolean",
	default: true,
	ui: {
		tab: "appearance",
...
export const cfgDisplayStreamingScrollback = register({
	id: "display.streamingScrollback",
	type: "boolean",
	default: false,
	ui: {
		tab: "appearance",
