...
import { resolveCompactionMethodOrder, resolveCompactionSettings, resolveMethodSettings } from "./compaction-methods";
...
export class SessionAdvisors {
	...
	async #maintainAdvisorContext(
		...
		const configuredCompaction = resolveCompactionSettings(this.#host.settings, advisorModel);
