...
/** Named model-role bundles (`modelProfiles`): profile name → role → model id. */
...
export const cfgModelProfile = register({ id: "modelProfile", type: "string", default: "" });

export const cfgModelProfileSwitchStyle = register({
	id: "modelProfileSwitchStyle",
	type: "enum",
 ...
 * allowlisted entry.
 */
export const cfgCyberModels = register({ id: "cyberModels", type: "array", default: EMPTY_STRING_ARRAY });
