...
const SETTING_HOOKS: Partial<Record<SettingPath, SettingHook<any>>> = {
	...
	"display.collapseCommandCards": value => {
		if (typeof value === "boolean") setChatTranscriptDisplayPreferences({ collapseCommandCards: value });
	},
	...
	"composerStyle.footerMode": value => {
		if (value === "default" || value === "claude3") setComposerStylePreferences({ footerMode: value });
	},
