...
| `app.model.cycleProfileForward`  | `Alt+Shift+M`                                                     | Cycle `modelProfiles` bundles forward ([Models](./models.md#model-profiles))                                                                                                         |
| `app.model.cycleProfileBackward` | Unbound                                                           | Cycle `modelProfiles` bundles backward                                                                                                                                               |
