...
| `app.model.cycleProfileForward`  | `Alt+Shift+M`                                                     | Choose a `modelProfiles` bundle (cycle forward with `modelProfileSwitchStyle: cycling`) ([Models](./models.md#model-profiles)) |
| `app.model.cycleProfileBackward` | Unbound                                                           | Choose a `modelProfiles` bundle (cycle backward with `modelProfileSwitchStyle: cycling`) |
...
| `app.model.toggleCyber`      | `Alt+Shift+X`                                                         | Toggle [cyber mode](./cyber-mode.md)                                                                                                                                                 |
